...
export type IncrementalDiffQuery = { repo_id: string, };

export type IncrementalDiffResponse = { diffs: Array<Diff>, base_commit: string | null, base_type: DiffBaseType, };

export type DiffBaseType = "last_merge" | "merge_base";
